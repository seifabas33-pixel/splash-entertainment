...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 28, fontWeight: '200', color: Brand.white, letterSpacing: 8 },
  divider: { width: 40, height: 2, backgroundColor: Brand.turquoise, marginVertical: 14 },
  subtitle: { fontSize: 12, color: 'rgba(255,255,255,0.6)', fontWeight: '500', letterSpacing: 0.5 },
  card: {
  ...
  modeBtnActive: { backgroundColor: Brand.turquoise },
  modeTxt: { fontSize: 11, fontWeight: '700', color: 'rgba(255,255,255,0.4)', letterSpacing: 1.5 },
  modeTxtActive: { color: '#000' },
  fieldWrap: { marginBottom: 16 },
  label: { fontSize: 10, fontWeight: '700', color: 'rgba(255,255,255,0.5)', letterSpacing: 1.5, marginBottom: 7 },
  input: {
    backgroundColor: 'rgba(255,255,255,0.08)', borderRadius: 12,
    borderWidth: 1, borderColor: 'rgba(255,255,255,0.14)',
    paddingHorizontal: 14, paddingVertical: 13, fontSize: 15, color: Brand.white,
  },
  ...
  photoBtn: {
    backgroundColor: 'rgba(255,255,255,0.08)', borderRadius: 12,
    borderWidth: 1, borderColor: 'rgba(255,255,255,0.14)',
    height: 90, alignItems: 'center', justifyContent: 'center', overflow: 'hidden',
  },
  photoBtnId: { height: 80 },
  photoBtnTxt: { fontSize: 14, color: 'rgba(255,255,255,0.45)', fontWeight: '600' },
  photoThumb: { width: 88, height: 88, borderRadius: 10 },
  photoThumbId: { width: '100%', height: 78, borderRadius: 10 },
  // Error / note
  errorBox: {
    backgroundColor: 'rgba(255,80,80,0.12)', borderRadius: 10,
    borderWidth: 1, borderColor: 'rgba(255,80,80,0.35)',
    paddingHorizontal: 14, paddingVertical: 10, marginBottom: 14,
  },
  errorTxt: { fontSize: 12, color: '#FF7070', fontWeight: '600', textAlign: 'center' },
  noteBox: {
    backgroundColor: 'rgba(255,200,0,0.08)', borderRadius: 10,
    borderWidth: 1, borderColor: 'rgba(255,200,0,0.25)',
    paddingHorizontal: 14, paddingVertical: 10, marginTop: 12,
  },
  noteTxt: { fontSize: 12, color: 'rgba(255,220,80,0.9)', textAlign: 'center', lineHeight: 18 },
  submitBtn: {
    backgroundColor: Brand.navy, borderRadius: 14, paddingVertical: 16,
