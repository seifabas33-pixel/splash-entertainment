...
const BASE_ACTIVITIES: Omit<Activity, 'id'>[] = [
  ...
  // ── Afternoon ────────────────────────────────────────────────────────────
  {
    ...
    description: 'Teams on the sand at Sahl Hasheesh Bay — all welcome!',
    icon: '🏖️',
  },
  {
    time: '16:00', displayTime: '4:00 PM',
    title: 'Yoga Class',
    location: 'Old Palace Beachfront',
  ...
  },
  {
    ...
    description: 'La Bonita comes alive — dance the night away until midnight!',
    icon: '🎶',
  },
];
...
export const EVENING_SHOWS: EveningShow[] = [
  {
    id: 'show-00',
    dayOfWeek: 0,
    title: 'Tanoura & Fire Show',
    venue: 'La Bonita',
    startTime: '8:45 PM',
    description: 'Spectacular Tanoura spinning and fire performance — a dazzling display of traditional Egyptian folklore.',
  },
  {
    id: 'show-01',
    dayOfWeek: 1,
    ...
    venue: 'Lobby Bar',
    startTime: '9:00 PM',
    description: 'Traditional Egyptian and Arabic folklore — music, belly dance, and authentic costumes.',
  },
  {
    id: 'show-02',
    dayOfWeek: 2,
  ...
  },
  {
    id: 'show-03',
    dayOfWeek: 3,
    title: 'Bedouin Night — Desert Magic',
    venue: 'La Bonita',
    startTime: '8:30 PM',
    description: 'Immersive Bedouin cultural experience with live Oud music, belly dance, and desert ambiance.',
  },
  {
    id: 'show-04',
    dayOfWeek: 4,
    title: 'Mr. & Ms. Old Palace',
    venue: 'La Bonita',
    startTime: '9:00 PM',
  ...
  },
  {
    id: 'show-05',
    dayOfWeek: 5,
    title: 'Crazy Raffle & Karaoke Night',
    venue: 'Lobby Bar / La Bonita',
    startTime: '9:00 PM',
    description: 'Win amazing prizes in the Crazy Raffle then take to the mic for Karaoke with the animation team.',
  },
  {
    id: 'show-06',
    dayOfWeek: 6,
    title: 'Live Music & Belly Dance Gala',
    venue: 'Lobby Bar',
    startTime: '7:00 PM',
    description: 'Live lounge band performance followed by a spectacular belly dance gala show.',
  },
];
